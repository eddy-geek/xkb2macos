...
Examples:
  ...
  %(prog)s --no-install --output ./bundles my_layout.keylayout
    ...
    parser.add_argument(
        'keylayout',
        type=Path,
        help='Path to .keylayout file'
    )
    
    parser.add_argument(
        '--name',
        help='Bundle name (default: derived from keylayout filename)'
    )
    
    parser.add_argument(
        '--bundle-id',
        help='Custom bundle identifier (default: auto-generated)'
    )
    
    parser.add_argument(
        '--icon',
        type=Path,
        help='Path to icon file (.png or .icns). PNG files will be automatically converted to ICNS.'
    )
    
    parser.add_argument(
        '--language',
        default='en-US',
        help='BCP 47 language code (default: en-US). Examples: fr-FR, de-DE, es-ES'
    )
    ...
    parser.add_argument(
        '--output',
        type=Path,
        help='Output directory for bundle (default: same as keylayout file)'
    )
    
    parser.add_argument(
        '--user',
        action='store_true',
        help='Install to ~/Library/Keyboard Layouts (default: /Library/Keyboard Layouts)'
    )
    
    parser.add_argument(
        '--no-install',
        action='store_true',
        help='Create bundle but do not install it'
    )
